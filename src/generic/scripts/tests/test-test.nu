...
#[test]
def test-get-tests-environment [] {
  let filters = {
    file: environment
    function: null
    module: null
...
#[test]
def test-get-tests-file-and-module [] {
  let filters = {
    file: history
    function: null
    module: generic
...
#[test]
def test-get-tests-function-and-module [] {
  let filters = {
    file: null
...
#[test]
def test-get-tests-file-funciton-and-module [] {
  let filters = {
    file: dependencies
    function: merge
    module: generic
